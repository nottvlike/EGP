...
export ECS_DEFINES="-d:UnityEditor;UNITY_5_3_OR_NEWER;UNITY_5_4_OR_NEWER;UNITY_5_5_OR_NEWER;UNITY_5_6_OR_NEWER;\
...
mcs $ECS_REFERENCES $ECS_DEFINES -sdk:4.7.1 -target:library $ECS_SRC -out:$CURENT_DIR/libAssetManager.dll

cd $CURENT_DIR

mv libAssetManager.dll ../../Assets/EGP/Plugins/libAssetManager.dll