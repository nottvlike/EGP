...
mcs $ECS_REFERENCES $ECS_DEFINES -sdk:4.7.1 -target:library $ECS_SRC -out:$CURENT_DIR/libECSUIEditor.dll

cd $CURENT_DIR

mv libECSUIEditor.dll ../../Assets/EGP/Editor/libECSUIEditor.dll