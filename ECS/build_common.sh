...
search_path $CURENT_DIR/Common

cd $UNITY_PATH/Contents/Mono/bin

mcs $ECS_REFERENCES $ECS_DEFINES -sdk:4.7.1 -target:library $ECS_SRC -out:$CURENT_DIR/libCommon.dll

cd $CURENT_DIR

mv libCommon.dll ../Assets/EGP/Plugins/libCommon.dll